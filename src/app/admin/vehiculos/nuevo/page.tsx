...
export default function NuevoVehiculoPage() {
  return (
    <div>
      ...
      <form action={crearVehiculoConFotos} className="bg-white rounded-lg shadow p-6 space-y-6">
        {/* Fotos - por ahora solo campo de texto para URLs */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Fotos del vehículo
          </label>
          <p className="text-xs text-gray-500 mb-2">
            Próximamente: upload de fotos. Por ahora podés agregar fotos después de crear el vehículo.
          </p>
        </div>
